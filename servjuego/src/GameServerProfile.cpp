...
GameServerProfile::GameServerProfile() {
	...
	mCreators.push_back(std::pair<int, TransferableCreator*>(3, new SetZoneToServerRcvd::Creator("SetZoneToServerRcvd")));
	...
	mCreators.push_back(std::pair<int, TransferableCreator*>(7, new SetZoneOrderRcvd::Creator("SetZoneOrderRcvd")));
